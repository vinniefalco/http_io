...
int main(int argc, char** argv)
{
    try
    {
        ...
        req.set( http_proto::method::get, target, http_proto::version::http_1_1 );
        req.fields.append( http_proto::field::host, host );
        req.fields.append( http_proto::field::user_agent, "Boost.HTTP-Proto" );
